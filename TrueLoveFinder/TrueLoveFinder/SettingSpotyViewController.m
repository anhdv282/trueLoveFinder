...
@interface SettingSpotyViewController ()

@end

@implementation SettingSpotyViewController {
...
{
    self = [super initWithMainImage:image tableScrollingType:MGSpotyViewTableScrollingTypeNormal]; //or MGSpotyViewTableScrollingTypeOver //MGSpotyViewTableScrollingTypeNormal
    if (self) {
